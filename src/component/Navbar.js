    ...
    return (
      <div>
        <nav id='nav' class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
          <Link id='title' class="navbar-brand mx-3" to="/india">Global Post</Link>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className='nav-item'><Link className={`nav-link ${this.state.linkDisable}`} to="/about">ABOUT</Link></li>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li><a className="dropdown-item" href="https://notion-one-jade.vercel.app/" target='_blank'>Notion</a></li>
